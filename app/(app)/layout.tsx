...
const navItems = [
  ...
  { href: "/surveys/new", label: "Surveys", icon: "▤" },
  { href: "/dashboard", label: "Responses", icon: "◧" },
  ...
  return (
    <div className="min-h-screen bg-[#050712] text-white">
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        ...
        <div className="absolute right-[-12rem] top-[14rem] h-[32rem] w-[32rem] rounded-full bg-violet-500/10 blur-[130px]" />
      </div>

      <div className="relative mx-auto flex min-h-screen max-w-[100rem]">
        <aside className="sticky top-0 hidden h-screen w-64 shrink-0 flex-col border-r border-white/10 bg-white/[0.03] p-6 backdrop-blur-2xl lg:flex">
