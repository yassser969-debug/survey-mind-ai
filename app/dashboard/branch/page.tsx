...
export default async function BranchPage() {
  ...
  const t = dict.branch;
  const statusLabels = dict.mySurveys.status;
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <p className="text-sm font-bold text-slate-300">
                  ...
                  <code
                    dir="ltr"
                    className="rounded-full border border-emerald-300/30 bg-emerald-300/10 px-4 py-1.5 text-base font-black tracking-[0.25em] text-emerald-200"
                  >
                    {branch.join_code}
                  </code>
                </p>
                        ...
                        {surveys.length > 0 && (
                          <div className="mt-4 overflow-x-auto">
                            <table className="w-full min-w-[36rem] text-sm">
                              <thead>
                                <tr className="text-start text-xs font-black uppercase tracking-wider text-slate-500">
                                  <th className="pb-2 pe-4 text-start">
                                    {t.colSurvey}
                                  </th>
                                  <th className="pb-2 pe-4 text-start">
                                    {t.colStatus}
                              ...
                              <tbody>
                                {surveys.map((survey, index) => (
                                  ...
                                  >
                                    <td className="py-2.5 pe-4 font-bold text-white">
                                      {survey.title}
                                    </td>
